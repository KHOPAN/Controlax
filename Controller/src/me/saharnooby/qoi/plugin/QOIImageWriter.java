...
public final class QOIImageWriter extends ImageWriter {
	...
	QOIImageWriter(ImageWriterSpi originatingProvider) {
	...
	private void writeImage(QOIImage converted) throws IOException {
	...
	private static QOIImage createFromBufferedImage( BufferedImage image) {
	...
	// Slowest method
	private static QOIImage createFromRaster(Raster raster, ColorModel colorModel) {
